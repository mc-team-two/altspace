...
<div class="find-container">
  ...
  <h4 class="font-weight-bold find-title">아이디 찾기</h4>
  <p class="text-muted find-subtitle">이메일을 입력하여 가입여부를 확인해보세요</p>

  <form id="findIdForm" method="post" action="/auth/find-password">
