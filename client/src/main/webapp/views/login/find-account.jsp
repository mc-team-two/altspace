...
<div class="find-container">
    <a href="/">
        <img src="<c:url value='/images/Altspace_lightmode_Horizontal.png'/>" alt="logo" style="height: 40px;"
             class="mb-4">
    </a>
    ...
    <form onsubmit="return false;">
        ...
        <button type="submit" id="findBtn" class="btn btn-find">ID/PW 찾기</button>
    </form>
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    ...
                    const msg = isJson
                        ...
                        : (xhr.responseText || '서버 오류가 발생했습니다.');
