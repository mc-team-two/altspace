                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-1680-4">
                    <div class="offers_image_container">
                      <div class="offers_image_background" style="background-image:url(<%--${acc.imageUrl}--%>)"></div>
                      <div class="offer_name"><a href="<c:url value="/offers/detail?id=${acc.accommodationId}"/>">${acc.name}</a></div>
                    </div>
                  </div>
                  <div class="col-lg-8">
                    <div class="offers_content">
                      ...
                      <div class="button book_button"><a href="<c:url value="/offers/detail?id=${acc.accommodationId}"/>">상세조회<span></span><span></span><span></span></a></div>

                      <div class="offer_reviews">
                        <div class="offer_reviews_content">
                          <div class="offer_reviews_title"><%--${acc.reviewTitle}--%></div>
                          <div class="offer_reviews_subtitle"><%--${acc.reviewCount}--%> reviews</div>
                        </div>
