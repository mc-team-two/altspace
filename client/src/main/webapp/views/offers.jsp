...
<div class="super_container">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <div class="user_box ml-auto">
                                    ...
                                    <div class="user_box_login user_box_link">
                                        <a href="<c:url value="/login/logout"/> ">logout</a></div>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="main_nav_container ml-auto">
                            <ul class="main_nav_list">
                                ...
                                <li class="main_nav_item"><a href="<c:url value="/mypage/aireport"/> ">예약 내역</a></li>
                            </ul>
                        </div>
    ...
    <div class="menu trans_500">
        <div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <div class="logo"><a href="/"><img src="../images/Altspace_darkmode_logo_small.png" alt="AltSpace Logo">AltSpace</a>
            </div>
            <ul>
                <li class="main_nav_item"><a href="<c:url value="/"/> ">홈</a></li>
                <li class="main_nav_item"><a href="<c:url value="/about"/> ">AltSpace란</a></li>
                <li class="main_nav_item"><a href="<c:url value="/faq1"/> ">고겍센터</a></li>
                <li class="main_nav_item"><a href="<c:url value="/mypage/aireport"/> ">예약 내역</a></li>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="offers_grid">
                        ...
                        <!-- 반복문으로 동적 출력 -->
                        <c:forEach var="acc" items="${accomm}">
                            <div class="offers_item rating_<%--${acc.rating}--%>">
                                <div class="row">
                                    <div class="col-lg-1 temp_col"></div>
                                    <div class="col-lg-3 col-1680-4">
                                        <div class="offers_image_container">
                                            <div class="offers_image_background"
                                                 style="background-image:url(<%--${acc.imageUrl}--%>)"></div>
                                            <div class="offer_name"><a
                                                    href="<c:url value="/offers/detail?id=${acc.accommodationId}"/>">${acc.name}</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="offers_content">
                                            <div class="offers_price">￦${acc.priceNight}<span>per night</span></div>

                                                <%--<div class="rating_r rating_r_&lt;%&ndash;${acc.rating}&ndash;%&gt; offers_rating" data-rating="&lt;%&ndash;${acc.rating}&ndash;%&gt;">
                                                  <i></i><i></i><i></i><i></i><i></i>
                                                </div>--%>

                                            <p class="offers_text">${acc.description}</p>

                                            <div class="offers_icons">
                                                    <%--<ul class="offers_icons_list">
                                                      <c:forEach var="icon" items="${acc.icons}">
                                                        <li class="offers_icons_item"><img src="${icon}" alt=""></li>
                                                      </c:forEach>
                                                    </ul>--%>
                                            </div>

                                            <div class="button book_button"><a
                                                    href="<c:url value="/offers/detail?id=${acc.accommodationId}"/>">상세조회<span></span><span></span><span></span></a>
                                            </div>

                                            <div class="offer_reviews">
                                                <div class="offer_reviews_content">
                                                    <div class="offer_reviews_title"><%--${acc.reviewTitle}--%></div>
                                                    <div class="offer_reviews_subtitle"><%--${acc.reviewCount}--%>
                                                        reviews
                                                    </div>
                                                </div>
                                                <div class="offer_reviews_rating text-center"><%--${acc.reviewScore}--%></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
